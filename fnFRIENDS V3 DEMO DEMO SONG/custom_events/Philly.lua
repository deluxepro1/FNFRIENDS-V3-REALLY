...
function updateOrder()
	...
	setObjectOrder('phillyWindowEvent', 10000)
	setObjectOrder('phillyGlowGradient', 10000)
	
	for i, j in pairs(partArray) do
		setObjectOrder(partArray[i].name, 10000)
	end
	
	--i don't know how to detect if a character is besides or in-front of another, so this will work for now
	setObjectOrder('gfGroup', 10000)
	setObjectOrder('dadGroup', 10000)
	setObjectOrder('boyfriendGroup', 10000)
