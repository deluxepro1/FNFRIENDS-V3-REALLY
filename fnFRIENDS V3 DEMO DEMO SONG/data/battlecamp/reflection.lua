...
--------------------------------------------------
    ...
    if showBF then
        ...
        setProperty('bfPhantom.y',getProperty('boyfriend.y') + getProperty('boyfriend.frameHeight')*getProperty('boyfriend.scale.y') * 2 - bfoffsetY * 2 - 30)
...
-----------------------------boyfriend sprite---------------------
    ...
    if showDAD then
        ...
        setProperty('dadPhantom.y',getProperty('dad.y') + getProperty('dad.frameHeight') * getProperty('dad.scale.y') * 2 - dadoffsetY * 2 - 100)
