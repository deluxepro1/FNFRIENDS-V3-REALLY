...
local decreaseRate = 70-- La velocidad a la que el sprite baja
local increaseRate = 60-- La velocidad a la que el sprite sube al presionar la tecla correspondiente
local sprite = 'hudSprite' -- Nombre del sprite en el HUD
local deathY = 500 -- Valor de Y donde Player 1 muere (Game Over)
local maxY = -100 -- Posición Y fuera de la pantalla, donde el sprite debe salir de la vista
local stopMoving = false -- Bandera para indicar que el sprite no debe moverse después de salir de la pantalla
local startTime = 133 -- Segundo en la canción cuando el sprite empieza a subir

-- Función para crear el sprite en el HUD
function onCreate()
    makeLuaSprite(sprite, 'muro2',0, spriteYStart) -- Cambia 'path/to/your/asset' por la ruta real del asset
    setObjectCamera(sprite, 'hudsprite') -- Asegúrate de que el sprite esté en el HUD
