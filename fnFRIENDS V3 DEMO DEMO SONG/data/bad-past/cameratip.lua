...
local cameraTarget = 'player1' -- 'player1' para BF, 'player2' para Dad
local startFixTime = 423-- Tiempo de inicio de la fijación (en segundos)
local endFixTime = 434-- Tiempo de fin de la fijación (en segundos)
