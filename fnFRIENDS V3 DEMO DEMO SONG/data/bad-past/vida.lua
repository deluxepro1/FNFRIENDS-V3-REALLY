...
local healthImages = { -- Tabla con las imágenes y sus rangos
    {image = 'topf3', minHealth = 0.75, maxHealth = 1.0}, -- Imagen 1: 75%-100% vida
    {image = 'topf2', minHealth = 0.50, maxHealth = 0.74}, -- Imagen 2: 50%-74% vida
    {image = 'topf1', minHealth = 0.25, maxHealth = 0.49}, -- Imagen 3: 25%-49% vida
    {image = 'vidaf1', minHealth = 0.00, maxHealth = 0.24}, -- Imagen 4: 0%-24% vida
}
...
function onCreate()
    ...
    for _, data in ipairs(healthImages) do
        makeLuaSprite(data.image, data.image, 0, -405) -- Ajusta las coordenadas según tu preferencia
