...
function onCreate()
makeLuaSprite('pared', 'stages/stagen/pared-new', -1500, -900)
addLuaSprite('pared', false)
scaleObject('pared', 1.45, 1.5)
setScrollFactor('pared', 0, 0)

makeLuaSprite('piso', 'stages/stagen/suelo-new', -1200, -650)
addLuaSprite('piso', false)
scaleObject('piso', 1.45, 1.5)
setScrollFactor('piso', 1, 1)

makeAnimatedLuaSprite('tele', 'stages/stagen/tele',-125,-500);
...
makeLuaSprite('cortinas', 'stages/stagen/cortinas-new', -1100, -875)
